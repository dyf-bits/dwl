...
static const float rootcolor[]             = COLOR(CHARC_DARK);
static const float bordercolor[]           = COLOR(CHARC_LIGHT4);
static const float focuscolor[]            = COLOR(CHARC_LIGHT1);
...
static const MonitorRule monrules[] = {
	...
	*/
	/* defaults */
	{ "DP-2",     0.55f, 1,      1.25, &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   -1,  -1 },
...
#define BRIGHTDN XF86XK_MonBrightnessDown
...
static const Key keys[] = {
	...
	{ 0,                         VOL_UP,             spawn,          SHCMD(volup) },
	{ 0,                         VOL_DOWN,           spawn,          SHCMD(voldown) },
	{ 0,                         VOL_MUTE,           spawn,          SHCMD(volmute) },
	{ 0,                         BRIGHTUP,           spawn,          SHCMD(brightup) },
	{ 0,                         BRIGHTDN,           spawn,          SHCMD(brightdown) },
